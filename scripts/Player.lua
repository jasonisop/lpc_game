...
function Player:setAnimation(facing,animationType)
	...
	if animationType =="attack" and  player.dead == false then
		...
		Player:setImageHEAD("Chars/png/slash/HEAD_hair_blonde.png")
		Player:setImageTORSO("Chars/png/slash/TORSO_leather_armor_torso.png")
		Player:setImageLEGS("Chars/png/slash/LEGS_pants_greenish.png")
		...
		Player:setImageSHOULDERS("Chars/png/slash/TORSO_leather_armor_shoulders.png")
