...
require('luascripts/Colors')

ChatWindow = GUI:new{ anim8 = require ('luascripts/anim8'), g = {}, animation = {}, x = 300,y = 100, closeButtonRect={},clicking=false,canDraw = true, textTable={}}
...
function ChatWindow:setup()
	...
	self:addText("Brandon's Adventure: Locked Out","System",base_Color )
